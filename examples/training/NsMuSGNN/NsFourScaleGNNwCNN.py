...
# Training datasets
path = "/home/nrehman/graphs4cfd/NsCircle/train/NsCircle.h5" # Replace with path to NsCircle.h5 (available at https://doi.org/10.5281/zenodo.7870707)
...
model = gfd.nn.NsFourScaleGNNwCNN(arch=arch)
